// src/tabs/SesChartTab.jsx
// Derived from ChartsTab.jsx — same date math and SVG rendering.
// Differences: no low/high lines, no forecast interval polygon; legend labels SES.
...
const VIEW = "engine.tsf_vw_daily_best_ses_a0";

export default function SesChartTab(){
  ...
  return (
    <div style={{width:"100%"}}>
      <h2 style={{marginTop:0}}>Forecast Chart — engine.tsf_vw_daily_best_ses_a0</h2>
      ...
      <SpecChart rows={rows} legendLabel="SES" />
    </div>
  );
}
