...
function LineChart({ data, width=520, height=220, monthStartISO }){
  ...
  const prerollStart = ymdUTC(minusDaysUTC(utcDateFromYmd(monthStartISO), 7));
...
export default function FourChartsTab(){
  ...
  const monthStartISO = startMonth || "";
  const dateFrom = monthStartISO ? ymdUTC(minusDaysUTC(utcDateFromYmd(monthStartISO), 7)) : "";
  const dateTo = monthStartISO ? ymdUTC(lastOfMonthUTC(utcDateFromYmd(monthStartISO))) : "";
