...
function PageParamsProvider(_a) {
    ...
    return (React.createElement(DataProvider, { name: "pageRoute", data: route, label: "Page route", advanced: true },
        React.createElement(DataProvider, { name: "pagePath", data: path, label: "Page path" },
            React.createElement(DataProvider, { name: "params", data: __assign(__assign({}, $ctx.params), params), label: "Page URL path params" },
                React.createElement(DataProvider, { name: "query", data: __assign(__assign({}, $ctx.query), query), label: "Page URL query params" }, children)))));
}
...
var GlobalActionsContext = React.createContext(undefined);
...
var PlasmicLinkContext = React.createContext(undefined);
...
function usePlasmicLink() {
    var Link = React.useContext(PlasmicLinkContext);
    if (Link) {
        return Link;
    }
    else {
...
exports.usePlasmicCanvasComponentInfo = usePlasmicCanvasComponentInfo;
